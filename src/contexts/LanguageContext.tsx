...
const translations = {
  en: {
    ...
    "home.hero.description":
      "Take control of your mental wellbeing with our comprehensive platform. Get AI-powered support, professional assessments, and connect with licensed experts - all in one safe space.",
    ...
    "home.features.aiSupport.description":
      "Get instant, personalized mental health guidance from our advanced AI assistant available 24/7.",
    "home.features.assessment.title": "Comprehensive Assessment",
    "home.features.assessment.description":
      "Take our scientifically-backed questionnaire to understand your mental health status and get tailored recommendations.",
    "home.features.expert.title": "Expert Consultation",
    "home.features.expert.description":
      "Connect with licensed mental health professionals for personalized one-on-one therapy sessions.",
    "home.features.safe.title": "Safe & Confidential",
    "home.features.safe.description":
      "Your privacy is our priority. All conversations and data are encrypted and completely confidential.",

    // CTA
    "home.cta.title": "Ready to Begin Your Journey?",
    "home.cta.description":
      "Join thousands who have taken the first step towards better mental health. Start with our quick assessment or chat with our AI assistant.",
  ...
  vi: {
    ...
    "home.features.subtitle":
      "Nền tảng của chúng tôi kết hợp công nghệ tiên tiến với chuyên môn con người để cung cấp hỗ trợ sức khỏe tinh thần toàn diện.",
    "home.features.aiSupport.title": "Hỗ Trợ Từ AI",
    "home.features.aiSupport.description":
      "Nhận hướng dẫn sức khỏe tinh thần tức thì và cá nhân hóa từ trợ lý AI tiên tiến có sẵn 24/7.",
    "home.features.assessment.title": "Đánh Giá Toàn Diện",
    "home.features.assessment.description":
      "Thực hiện bảng câu hỏi được hỗ trợ bởi khoa học để hiểu tình trạng sức khỏe tinh thần và nhận đề xuất phù hợp.",
    "home.features.expert.title": "Tư Vấn Chuyên Gia",
    "home.features.expert.description":
      "Kết nối với các chuyên gia sức khỏe tinh thần được cấp phép cho các buổi trị liệu cá nhân một-đối-một.",
    "home.features.safe.title": "An Toàn & Bảo Mật",
    "home.features.safe.description":
      "Quyền riêng tư của bạn là ưu tiên hàng đầu. Tất cả cuộc trò chuyện và dữ liệu đều được mã hóa và hoàn toàn bảo mật.",

    // CTA
    "home.cta.title": "Sẵn Sàng Bắt Đầu Hành Trình?",
    "home.cta.description":
      "Tham gia cùng hàng nghìn người đã thực hiện bước đầu tiên hướng tới sức khỏe tinh thần tốt hơn. Bắt đầu với đánh giá nhanh hoặc trò chuyện với trợ lý AI.",
    ...
    "home.testimonials.subtitle":
      "Những câu chuyện thực từ những người đã tìm thấy sự hỗ trợ qua nền tảng của chúng tôi",
